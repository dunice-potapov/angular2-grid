...
var NgGridItem = (function () {
    ...
    NgGridItem.propDecorators = {
        ...
        'onDragStop': [{ type: core_1.Output },],
        'onDragAny': [{ type: core_1.Output },],
        'onResizeStart': [{ type: core_1.Output },],
        'onResize': [{ type: core_1.Output },],
        'onResizeStop': [{ type: core_1.Output },],
        'onResizeAny': [{ type: core_1.Output },],
        'onChangeStart': [{ type: core_1.Output },],
        'onChange': [{ type: core_1.Output },],
        'onChangeStop': [{ type: core_1.Output },],
        'onChangeAny': [{ type: core_1.Output },],
        'ngGridItemChange': [{ type: core_1.Output },],
    };
    return NgGridItem;
}());
